  ...
  return (
    <>
      <div className='flex flex-row'>
        <a
          href='https://github.com/edubz99'
          target='_blank'
          rel='noopener noreferrer'
          className='rounded-full'
        >
          <Avatar className='size-40 shadow border'>
            <AvatarImage alt={avatar.name} src={'/assets/avatar_evans.webp'} />
      ...
      <div className='flex items-center flex-row gap-4'>
        ...
        >
          <a
            href='https://www.linkedin.com/in/evdevelops'
            target='_blank'
            rel='noopener noreferrer'
